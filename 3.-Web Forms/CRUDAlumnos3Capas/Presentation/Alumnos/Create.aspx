    ...
    <div class="row justify-content">
        ...
        <div class="mb-3 row form-group">
            ...
            <div class="col-md-7">
                ...
                <div>
                    <asp:CustomValidator ID="cvCurpCoincidaFechaNac" runat="server" ErrorMessage="El campo CURP no coincide con la fecha de nacimiento" CssClass="text-danger" ControlToValidate="txtCurp" ClientValidationFunction="CURPvsFechaNac"></asp:CustomValidator>
                </div>
                <div>
        ...
        <div class="mb-3 row form-group">
            ...
            <div>
                <asp:RangeValidator ID="rvSueldo" runat="server" ErrorMessage="El sueldo debe de estar entre 10000 y 40000" CssClass="text-danger" ControlToValidate="txtSueldo" Type="Currency" MaximumValue="40000" MinimumValue="10000"></asp:RangeValidator>
            </div>
