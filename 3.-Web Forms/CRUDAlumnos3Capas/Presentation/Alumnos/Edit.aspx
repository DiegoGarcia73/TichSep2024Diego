    ...
    <div class="row justify-content">
        ...
        <div class="col-md-5">
            <div class="mb-2 row form-group">
                <asp:Label ID="lblID" class="control-label col-md-5 fw-bold text-end" runat="server" Text="ID"></asp:Label>
                <div class="col-md-7">
                    <asp:TextBox ID="txtID" CssClass="col-md-9" runat="server" Enabled="false"></asp:TextBox>
                </div>
            </div>
            <div class="mb-2 row form-group">
            ...
            <div class="mb-2 row form-group">
                ...
                <div class="col-md-7">
                    ...
                    <asp:CustomValidator Text="*" ID="cvCURPFechavsNac" runat="server" ErrorMessage="La fecha de nacimiento no coincide con la CURP" CssClass="text-danger" ControlToValidate="txtCurp" OnServerValidate="cvCURPFechavsNac_ServerValidate"></asp:CustomValidator>
                </div>
            </div>
            <div class="mb-2 row form-group">
                ...
                <div class="col-md-7">
                    ...
                    <asp:RangeValidator Text="*" ID="rvSueldo" runat="server" ErrorMessage="El sueldo debe estar entre 10000 y 40000" CssClass="text-danger" ControlToValidate="txtSueldo" Type="Currency" MaximumValue="40000" MinimumValue="10000"></asp:RangeValidator>
                </div>
            </div>
            <div class="mb-2 row form-group">
